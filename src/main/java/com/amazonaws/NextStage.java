...
public class NextStage {
	 ...
	 * 
	 * @param fxmlLoader    An FXMLLoader containing fxml file data to open a new
	 *                      stage
	 * @param closeStageBtn A button representing an element on the current stage as
	 *                      a reference point to close the current stage
