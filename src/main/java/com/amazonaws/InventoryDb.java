...
public class InventoryDb extends DatabaseTable {
	...
	/**
	 * Changes the quantity of the specified toppingName with the specified quantity
	 * in the Inventory Database. The change is specified by the option
	 * 
	 ...
	 * @return An integer representing the quantity of the toppingName if valid If
	 *         the toppingName is not found in the database, returns -1
	 */
	...
	/**
	 * Adds an inventory item to the Inventory Database with the specified name and
	 * quantity
	 * 
	 * @param name     A string representing the inventory item's name
	 * @param quantity An integer representing the inventory item's quantity
	 * @return True if the inventory item can be added, false otherwise If the
	 *         inventory item already exists in the Inventory Database, then the
	 *         inventory item cannot be added
	 */
	 ...
	 * 
	 * @param name A string representing the inventory item's name
	 * @return True if the inventory item can be deleted, false otherwise If the
	 *         inventory item is not found in the Inventory Database, then the
	 ...
	 * 
	 * @return A list of InventoryItem representing all InventoryItem in the
	 *         Inventory Database
	 */
