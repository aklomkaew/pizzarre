...
public class MyDrinkConverter implements DynamoDBTypeConverter<String, List<Drink>> {
	...
	/**
	 * Converts the specified list of Drink to string so it can be stored in DynamoDB
	 */
	@Override
	...
	/**
	 * Unconverts the specified string object to list of Drink so that the class can process the object
	 */
	@Override
