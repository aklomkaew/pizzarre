...
public class RecipeDb extends DatabaseTable {
	 ...
	 * 
	 * @param item A RecipeItem object representing the recipe to be added to the
	 *             Recipe Database
	 * @return True if the RecipeItem object can be added, false otherwise If the
	 *         RecipeItem object already exists in the Recipe Database, then the
	 *         RecipeItem object cannot be added
	 */
	public static boolean addRecipe(RecipeItem item) {
		...
		DynamoDBScanExpression scanExpression = new DynamoDBScanExpression().withFilterExpression("RecipeName = :val1")
	 ...
	 * @return True if the RecipeItem object can be deleted, false otherwise If the
	 *         RecipeItem object is not found in the Recipe Database, then the
	 *         RecipeItem object cannot be deleted
	 */
	 ...
	 * 
	 * @return A list of RecipeItem representing all RecipeItem object in the Recipe
	 *         Database
	 */
