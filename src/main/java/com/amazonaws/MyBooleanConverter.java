 ...
 * @author Atchima
 * Reference: https://stackoverflow.com/questions/45384293/dynamodb-dynamodb-mapper-returns-null-for-boolean-value
 */
public class MyBooleanConverter implements DynamoDBTypeConverter<String, Boolean> {

	/**
	 * Converts the specified boolean object to string so it can be stored in DynamoDB
	 */
	@Override
	...
	/**
	 * Unconverts the specified string object to boolean so that the class can process the variable
	 */
	@Override
